        ...
        runButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (numOfCoins <= 2000000000) {
                    ...
                    //let the user know if they have too many coins
                    Toast toast = Toast.makeText(getApplicationContext(), getString(R.string.too_many_coins), Toast.LENGTH_SHORT);
                    toast.show();
                }
        ...
        upgradeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (numOfUpgrades <= 500000 && coinsPerRun <= 2000000000){
                    ...
                    //let the user know if they have too many upgrades
                    Toast toast = Toast.makeText(getApplicationContext(), getString(R.string.too_many_upgrades), Toast.LENGTH_SHORT);
                    toast.show();
                }
